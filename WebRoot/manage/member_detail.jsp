...
<table width="800" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="932" valign="top" background="images/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">会员详情</div></td>
      </tr>
    </table></td>
...
<table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0">
            <tr>
             ...
             <table width="750"  border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder_dashed">
                  <tr>
                    <td width="20%" height="27" align="right" class="tableBorder_B_dashed"> 　　　　 　 &nbsp;用 户 名： 　　 </td>
                    <td height="13" align="left" class="tableBorder_B_dashed"> &nbsp;<%=username%>                    </td>
                  </tr>
                  <tr>
                    <td height="27" align="right" class="tableBorder_B_dashed">　　　　　&nbsp;真实姓名：</td>
                    <td height="14" align="left" class="tableBorder_B_dashed">&nbsp;<%=Truename%></td>
                  </tr>
                  <tr>
                    <td height="27" align="right" class="tableBorder_B_dashed">&nbsp;　　　　　　城&nbsp;&nbsp;&nbsp;&nbsp;市：</td>
                    <td align="left" class="tableBorder_B_dashed">&nbsp;<%=city%>
                    </td>
                  </tr>
                  <tr>
                    <td height="27" align="right" class="tableBorder_B_dashed">&nbsp;　　地&nbsp;&nbsp;&nbsp;&nbsp;址：</td>
                    <td height="14" align="left" class="tableBorder_B_dashed">&nbsp;<%=address%></td>
                  </tr>
                  <tr>
                    <td height="27" align="right" class="tableBorder_B_dashed">&nbsp;　邮政编码：</td>
                    <td width="80%" height="27" align="left" class="tableBorder_B_dashed">&nbsp;<%=postcode%>
                    </td>
                  </tr>
                  <tr>
                    <td height="27" align="right" class="tableBorder_B_dashed">&nbsp;　证件类型：</td>
                    <td height="14" align="left" class="tableBorder_B_dashed">&nbsp;<%=CardType%> </td>
                  </tr>
                  <tr>
                    <td height="27" align="right" class="tableBorder_B_dashed">&nbsp;　证件号码：</td>
                    <td align="left" class="tableBorder_B_dashed">&nbsp;<%=CardNO%>
                    </td>
                  </tr>
                  <tr>
                    <td height="27" align="right" class="tableBorder_B_dashed">&nbsp;　 电&nbsp;&nbsp;&nbsp; &nbsp;话：</td>
                  ...
                  <tr>
                    <td height="27" align="right" class="tableBorder_B_dashed">&nbsp;消 费 额：</td>
                    <td align="left" class="tableBorder_B_dashed">&nbsp;<%=Amount%> (元)</td>
                  </tr>
                  <tr>
