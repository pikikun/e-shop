...
if (rs.next()){
	...
	if (ret!=0){
          out.println("<script language='javascript'>alert('小分类信息添加成功！');window.location.href='index.jsp?id=7';</script>");
        }else{
          out.println("<script language='javascript'>alert('小分类信息添加失败！');window.location.href='sub_add.jsp?id=8';</script>");
        }
}
%>